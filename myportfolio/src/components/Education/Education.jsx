  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-16">
        ...
        <div className="w-56 h-1 bg-[#ecfof1] mx-auto mt-4"></div>
        ...
        {education.map((edu, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Card */}
              <div
                className={`w-full sm:w-[45%] p-6 rounded-2xl border border-gray-300 bg-[#ecf0f1] shadow-xl transition-transform duration-300 hover:scale-105 ${isLeft ? "sm:ml-0 sm:mr-auto" : "sm:ml-auto sm:mr-0"
                  }`}
              >
