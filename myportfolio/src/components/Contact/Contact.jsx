...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        "service_fepfmm8",  // Replace with your EmailJS Service ID
        "template_q5n3e8s",  // Replace with your EmailJS Template ID
        form.current,
        "lqZc4Sw061CUjhU2l"  // Replace with your EmailJS Public Key
      )
      .then(
        () => {
          setIsSent(true);
